...
let Upload_file_morphCrudResolver = class Upload_file_morphCrudResolver {
    ...
    async findFirstUpload_file_morph(ctx, info, args) {
        const { _count } = helpers_1.transformFields(graphql_fields_1.default(info));
        return helpers_1.getPrismaFromContext(ctx).upload_file_morph.findFirst({
            ...args,
            ...(_count && helpers_1.transformCountFieldIntoSelectRelationsCount(_count)),
        });
    }
    async upload_file_morphs(ctx, info, args) {
        const { _count } = helpers_1.transformFields(graphql_fields_1.default(info));
        return helpers_1.getPrismaFromContext(ctx).upload_file_morph.findMany({
            ...args,
            ...(_count && helpers_1.transformCountFieldIntoSelectRelationsCount(_count)),
        });
    }
    async createUpload_file_morph(ctx, info, args) {
        const { _count } = helpers_1.transformFields(graphql_fields_1.default(info));
        return helpers_1.getPrismaFromContext(ctx).upload_file_morph.create({
            ...args,
            ...(_count && helpers_1.transformCountFieldIntoSelectRelationsCount(_count)),
        });
    }
    ...
    async deleteUpload_file_morph(ctx, info, args) {
        const { _count } = helpers_1.transformFields(graphql_fields_1.default(info));
        return helpers_1.getPrismaFromContext(ctx).upload_file_morph.delete({
            ...args,
            ...(_count && helpers_1.transformCountFieldIntoSelectRelationsCount(_count)),
        });
    }
    async updateUpload_file_morph(ctx, info, args) {
        const { _count } = helpers_1.transformFields(graphql_fields_1.default(info));
        return helpers_1.getPrismaFromContext(ctx).upload_file_morph.update({
            ...args,
            ...(_count && helpers_1.transformCountFieldIntoSelectRelationsCount(_count)),
        });
    }
    async deleteManyUpload_file_morph(ctx, info, args) {
        const { _count } = helpers_1.transformFields(graphql_fields_1.default(info));
        return helpers_1.getPrismaFromContext(ctx).upload_file_morph.deleteMany({
            ...args,
            ...(_count && helpers_1.transformCountFieldIntoSelectRelationsCount(_count)),
        });
    }
    async updateManyUpload_file_morph(ctx, info, args) {
        const { _count } = helpers_1.transformFields(graphql_fields_1.default(info));
        return helpers_1.getPrismaFromContext(ctx).upload_file_morph.updateMany({
            ...args,
            ...(_count && helpers_1.transformCountFieldIntoSelectRelationsCount(_count)),
        });
    }
    async upsertUpload_file_morph(ctx, info, args) {
        const { _count } = helpers_1.transformFields(graphql_fields_1.default(info));
        return helpers_1.getPrismaFromContext(ctx).upload_file_morph.upsert({
            ...args,
            ...(_count && helpers_1.transformCountFieldIntoSelectRelationsCount(_count)),
        });
    }
    async aggregateUpload_file_morph(ctx, info, args) {
        return helpers_1.getPrismaFromContext(ctx).upload_file_morph.aggregate({
            ...args,
    ...
    async groupByUpload_file_morph(ctx, info, args) {
        ...
        return helpers_1.getPrismaFromContext(ctx).upload_file_morph.groupBy({
            ...args,
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, FindUniqueUpload_file_morphArgs_1.FindUniqueUpload_file_morphArgs]),
...
__decorate([
    ...
    __param(0, TypeGraphQL.Ctx()), __param(1, TypeGraphQL.Info()), __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, FindFirstUpload_file_morphArgs_1.FindFirstUpload_file_morphArgs]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, TypeGraphQL.Ctx()), __param(1, TypeGraphQL.Info()), __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, FindManyUpload_file_morphArgs_1.FindManyUpload_file_morphArgs]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, TypeGraphQL.Ctx()), __param(1, TypeGraphQL.Info()), __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, CreateUpload_file_morphArgs_1.CreateUpload_file_morphArgs]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, TypeGraphQL.Ctx()), __param(1, TypeGraphQL.Info()), __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, DeleteUpload_file_morphArgs_1.DeleteUpload_file_morphArgs]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, TypeGraphQL.Ctx()), __param(1, TypeGraphQL.Info()), __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, UpdateUpload_file_morphArgs_1.UpdateUpload_file_morphArgs]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, TypeGraphQL.Ctx()), __param(1, TypeGraphQL.Info()), __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, DeleteManyUpload_file_morphArgs_1.DeleteManyUpload_file_morphArgs]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, TypeGraphQL.Ctx()), __param(1, TypeGraphQL.Info()), __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, UpdateManyUpload_file_morphArgs_1.UpdateManyUpload_file_morphArgs]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, TypeGraphQL.Ctx()), __param(1, TypeGraphQL.Info()), __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, UpsertUpload_file_morphArgs_1.UpsertUpload_file_morphArgs]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, TypeGraphQL.Ctx()), __param(1, TypeGraphQL.Info()), __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, AggregateUpload_file_morphArgs_1.AggregateUpload_file_morphArgs]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, TypeGraphQL.Ctx()), __param(1, TypeGraphQL.Info()), __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, GroupByUpload_file_morphArgs_1.GroupByUpload_file_morphArgs]),
    __metadata("design:returntype", Promise)
], Upload_file_morphCrudResolver.prototype, "groupByUpload_file_morph", null);
Upload_file_morphCrudResolver = __decorate([
...
//# sourceMappingURL=Upload_file_morphCrudResolver.js.map