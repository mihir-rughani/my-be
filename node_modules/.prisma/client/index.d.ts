...
export class PrismaClient<
  ...
  */
   ...
   * `prisma.favourites`: Exposes CRUD operations for the **favourites** model.
    ...
    * ```
    */
  get favourites(): Prisma.favouritesDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  export type venuesSelect = {
    ...
    uploadFileMorph?: boolean | upload_file_morphFindManyArgs
    favourite?: boolean | favouritesArgs
    itinerary_places?: boolean | itinerary_placesArgs
  }
  ...
  export type venuesGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        P extends 'uploadFileMorph'
        ? Array < upload_file_morphGetPayload<S['include'][P]>>  :
        P extends 'favourite'
        ? favouritesGetPayload<S['include'][P]> | null :
        P extends 'itinerary_places'
        ? itinerary_placesGetPayload<S['include'][P]> | null : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
        ...
        P extends 'uploadFileMorph'
        ? Array < upload_file_morphGetPayload<S['select'][P]>>  :
        P extends 'favourite'
        ? favouritesGetPayload<S['select'][P]> | null :
        P extends 'itinerary_places'
        ? itinerary_placesGetPayload<S['select'][P]> | null : never
  } 
    : venues
  : venues
  ...
  export class Prisma__venuesClient<T> implements PrismaPromise<T> {
    ...
    favourite<T extends favouritesArgs = {}>(args?: Subset<T, favouritesArgs>): CheckSelect<T, Prisma__favouritesClient<favourites | null >, Prisma__favouritesClient<favouritesGetPayload<T> | null >>;

    itinerary_places<T extends itinerary_placesArgs = {}>(args?: Subset<T, itinerary_placesArgs>): CheckSelect<T, Prisma__itinerary_placesClient<itinerary_places | null >, Prisma__itinerary_placesClient<itinerary_placesGetPayload<T> | null >>;
  ...
  export type Itinerary_placesGroupByOutputType = {
    ...
    itinerary_id: number
    user_id: string | null
    venue_data: JsonValue
    bestFor: JsonValue | null
    created_by: number | null
    updated_by: number | null
    created_at: Date | null
    updated_at: Date | null
  ...
  export type itinerary_placesGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
          P extends 'venue'
        ? venuesGetPayload<S['include'][P]> | null :
        P extends 'itinerary'
  ...
  : 
          P extends 'venue'
        ? venuesGetPayload<S['select'][P]> | null :
        P extends 'itinerary'
  ...
  export class Prisma__itinerary_placesClient<T> implements PrismaPromise<T> {
    ...
    venue<T extends venuesArgs = {}>(args?: Subset<T, venuesArgs>): CheckSelect<T, Prisma__venuesClient<venues | null >, Prisma__venuesClient<venuesGetPayload<T> | null >>;
  ...
  export type AggregateFavourites = {
    ...
    count: FavouritesCountAggregateOutputType | null
    _avg: FavouritesAvgAggregateOutputType | null
    avg: FavouritesAvgAggregateOutputType | null
    _sum: FavouritesSumAggregateOutputType | null
    sum: FavouritesSumAggregateOutputType | null
    _min: FavouritesMinAggregateOutputType | null
    min: FavouritesMinAggregateOutputType | null
    _max: FavouritesMaxAggregateOutputType | null
    max: FavouritesMaxAggregateOutputType | null
  }
  ...
  export type FavouritesAggregateArgs = {
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<favouritesOrderByInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
    ...
    **/
     ...
     * @deprecated since 2.23.0 please use `_count`
    **/
    count?: true | FavouritesCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to average
    **/
     ...
     * @deprecated since 2.23.0 please use `_avg`
    **/
    avg?: FavouritesAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
     ...
     * @deprecated since 2.23.0 please use `_sum`
    **/
    sum?: FavouritesSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
     ...
     * @deprecated since 2.23.0 please use `_min`
    **/
    min?: FavouritesMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
     ...
     * @deprecated since 2.23.0 please use `_max`
    **/
    max?: FavouritesMaxAggregateInputType
  }
  ...
  export type FavouritesGroupByArgs = {
    where?: favouritesWhereInput
    orderBy?: Enumerable<favouritesOrderByInput>
    by: Array<FavouritesScalarFieldEnum>
  ...
  type GetFavouritesGroupByPayload<T extends FavouritesGroupByArgs> = Promise<
    Array<
      PickArray<FavouritesGroupByOutputType, T['by']> & 
        {
  ...
  export type favouritesGetPayload<
    S extends boolean | null | undefined | favouritesArgs,
    U = keyof S
      > = S extends true
        ? favourites
    : S extends undefined
    ? never
    : S extends favouritesArgs | favouritesFindManyArgs
    ?'include' extends U
    ? favourites  & {
    [P in TrueKeys<S['include']>]: 
          P extends 'venue'
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof favourites ?favourites [P]
  : 
          P extends 'venue'
        ? venuesGetPayload<S['select'][P]> | null : never
  } 
  ...
  export interface favouritesDelegate<GlobalRejectSettings> {
     ...
     * })
    **/
    findUnique<T extends favouritesFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, favouritesFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'favourites'> extends True ? CheckSelect<T, Prisma__favouritesClient<favourites>, Prisma__favouritesClient<favouritesGetPayload<T>>> : CheckSelect<T, Prisma__favouritesClient<favourites | null >, Prisma__favouritesClient<favouritesGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends favouritesFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, favouritesFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'favourites'> extends True ? CheckSelect<T, Prisma__favouritesClient<favourites>, Prisma__favouritesClient<favouritesGetPayload<T>>> : CheckSelect<T, Prisma__favouritesClient<favourites | null >, Prisma__favouritesClient<favouritesGetPayload<T> | null >>
    ...
    **/
    findMany<T extends favouritesFindManyArgs>(
      args?: SelectSubset<T, favouritesFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<favourites>>, PrismaPromise<Array<favouritesGetPayload<T>>>>
    ...
    **/
    create<T extends favouritesCreateArgs>(
      args: SelectSubset<T, favouritesCreateArgs>
    ): CheckSelect<T, Prisma__favouritesClient<favourites>, Prisma__favouritesClient<favouritesGetPayload<T>>>
    ...
    **/
    createMany<T extends favouritesCreateManyArgs>(
      args?: SelectSubset<T, favouritesCreateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    delete<T extends favouritesDeleteArgs>(
      args: SelectSubset<T, favouritesDeleteArgs>
    ): CheckSelect<T, Prisma__favouritesClient<favourites>, Prisma__favouritesClient<favouritesGetPayload<T>>>
    ...
    **/
    update<T extends favouritesUpdateArgs>(
      args: SelectSubset<T, favouritesUpdateArgs>
    ): CheckSelect<T, Prisma__favouritesClient<favourites>, Prisma__favouritesClient<favouritesGetPayload<T>>>
    ...
    **/
    deleteMany<T extends favouritesDeleteManyArgs>(
      args?: SelectSubset<T, favouritesDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    updateMany<T extends favouritesUpdateManyArgs>(
      args: SelectSubset<T, favouritesUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    upsert<T extends favouritesUpsertArgs>(
      args: SelectSubset<T, favouritesUpsertArgs>
    ): CheckSelect<T, Prisma__favouritesClient<favourites>, Prisma__favouritesClient<favouritesGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends FavouritesAggregateArgs>(args: Subset<T, FavouritesAggregateArgs>): PrismaPromise<GetFavouritesAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, FavouritesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFavouritesGroupByPayload<T> : Promise<InputErrors>
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__favouritesClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export type favouritesFindUniqueArgs = {
     ...
     * 
    **/
    select?: favouritesSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     * 
    **/
    include?: favouritesInclude | null
    /**
     * Throw an Error if a favourites can't be found
     * 
    **/
    rejectOnNotFound?: RejectOnNotFound
    /**
  ...
  export type favouritesFindFirstArgs = {
    ...
    **/
     ...
     * 
    **/
    distinct?: Enumerable<FavouritesScalarFieldEnum>
  }
  ...
  export type favouritesCreateManyArgs = {
    data: Enumerable<favouritesCreateManyInput>
    skipDuplicates?: boolean
  }
  ...
  export type venuesWhereInput = {
    ...
    uploadFileMorph?: Upload_file_morphListRelationFilter
    favourite?: XOR<FavouritesRelationFilter, favouritesWhereInput> | null
    itinerary_places?: XOR<Itinerary_placesRelationFilter, itinerary_placesWhereInput> | null
  }
  ...
  export type itinerary_placesWhereInput = {
    ...
    id?: IntFilter | number
    itinerary_id?: IntFilter | number
    user_id?: StringNullableFilter | string | null
    venue_data?: JsonFilter
    bestFor?: JsonNullableFilter
    created_by?: IntNullableFilter | number | null
    updated_by?: IntNullableFilter | number | null
    created_at?: DateTimeNullableFilter | Date | string | null
    updated_at?: DateTimeNullableFilter | Date | string | null
    ...
    venue_id?: IntNullableFilter | number | null
    venue?: XOR<VenuesRelationFilter, venuesWhereInput> | null
  ...
  export type itinerary_placesScalarWhereWithAggregatesInput = {
    ...
    id?: IntWithAggregatesFilter | number
    itinerary_id?: IntWithAggregatesFilter | number
    user_id?: StringNullableWithAggregatesFilter | string | null
    venue_data?: JsonWithAggregatesFilter
    bestFor?: JsonNullableWithAggregatesFilter
    created_by?: IntNullableWithAggregatesFilter | number | null
    updated_by?: IntNullableWithAggregatesFilter | number | null
    created_at?: DateTimeNullableWithAggregatesFilter | Date | string | null
    updated_at?: DateTimeNullableWithAggregatesFilter | Date | string | null
    ...
    venue_id?: IntNullableWithAggregatesFilter | number | null
  }

  export type favouritesWhereInput = {
    AND?: Enumerable<favouritesWhereInput>
    OR?: Enumerable<favouritesWhereInput>
    NOT?: Enumerable<favouritesWhereInput>
    id?: IntFilter | number
    user_id?: StringNullableFilter | string | null
    bestFor?: JsonNullableFilter
    venue_id?: IntNullableFilter | number | null
  ...
  export type favouritesOrderByInput = {
    id?: SortOrder
    user_id?: SortOrder
    bestFor?: SortOrder
    venue_id?: SortOrder
  ...
  export type favouritesWhereUniqueInput = {
    id?: number
  }

  export type favouritesScalarWhereWithAggregatesInput = {
    AND?: Enumerable<favouritesScalarWhereWithAggregatesInput>
    OR?: Enumerable<favouritesScalarWhereWithAggregatesInput>
    NOT?: Enumerable<favouritesScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
    user_id?: StringNullableWithAggregatesFilter | string | null
    bestFor?: JsonNullableWithAggregatesFilter
    venue_id?: IntNullableWithAggregatesFilter | number | null
  ...
  export type venuesCreateInput = {
    ...
    favourite?: favouritesCreateNestedOneWithoutVenueInput
    itinerary_places?: itinerary_placesCreateNestedOneWithoutVenueInput
  }
  ...
  export type venuesUncheckedCreateInput = {
    ...
    favourite?: favouritesUncheckedCreateNestedOneWithoutVenueInput
    itinerary_places?: itinerary_placesUncheckedCreateNestedOneWithoutVenueInput
  }
  ...
  export type venuesUpdateInput = {
    ...
    favourite?: favouritesUpdateOneWithoutVenueInput
    itinerary_places?: itinerary_placesUpdateOneWithoutVenueInput
  }
  ...
  export type venuesUncheckedUpdateInput = {
    ...
    favourite?: favouritesUncheckedUpdateOneWithoutVenueInput
    itinerary_places?: itinerary_placesUncheckedUpdateOneWithoutVenueInput
  }
  ...
  export type itinerary_placesCreateInput = {
    user_id?: string | null
    venue_data: InputJsonValue
    bestFor?: InputJsonValue | null
    created_by?: number | null
    updated_by?: number | null
    created_at?: Date | string | null
    updated_at?: Date | string | null
    ...
    venue?: venuesCreateNestedOneWithoutItinerary_placesInput
  ...
  export type itinerary_placesUpdateInput = {
    ...
    venue?: venuesUpdateOneWithoutItinerary_placesInput
  ...
  export type favouritesCreateInput = {
    ...
    created_at?: Date | string | null
    updated_at?: Date | string | null
    venue?: venuesCreateNestedOneWithoutFavouriteInput
  }
  ...
  export type favouritesUpdateInput = {
    ...
    created_at?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    updated_at?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    venue?: venuesUpdateOneWithoutFavouriteInput
  }
  ...
  export type FavouritesRelationFilter = {
    is?: favouritesWhereInput | null
    isNot?: favouritesWhereInput | null
  }

  export type Itinerary_placesRelationFilter = {
    is?: itinerary_placesWhereInput | null
    isNot?: itinerary_placesWhereInput | null
  }
  ...
  export type favouritesCreateNestedOneWithoutVenueInput = {
    create?: XOR<favouritesCreateWithoutVenueInput, favouritesUncheckedCreateWithoutVenueInput>
    connectOrCreate?: favouritesCreateOrConnectWithoutVenueInput
    connect?: favouritesWhereUniqueInput
  }

  export type itinerary_placesCreateNestedOneWithoutVenueInput = {
    create?: XOR<itinerary_placesCreateWithoutVenueInput, itinerary_placesUncheckedCreateWithoutVenueInput>
    connectOrCreate?: itinerary_placesCreateOrConnectWithoutVenueInput
    connect?: itinerary_placesWhereUniqueInput
  }
  ...
  export type favouritesUncheckedCreateNestedOneWithoutVenueInput = {
    create?: XOR<favouritesCreateWithoutVenueInput, favouritesUncheckedCreateWithoutVenueInput>
    connectOrCreate?: favouritesCreateOrConnectWithoutVenueInput
    connect?: favouritesWhereUniqueInput
  }

  export type itinerary_placesUncheckedCreateNestedOneWithoutVenueInput = {
    create?: XOR<itinerary_placesCreateWithoutVenueInput, itinerary_placesUncheckedCreateWithoutVenueInput>
    connectOrCreate?: itinerary_placesCreateOrConnectWithoutVenueInput
    connect?: itinerary_placesWhereUniqueInput
  }
  ...
  export type favouritesUpdateOneWithoutVenueInput = {
    create?: XOR<favouritesCreateWithoutVenueInput, favouritesUncheckedCreateWithoutVenueInput>
    connectOrCreate?: favouritesCreateOrConnectWithoutVenueInput
    upsert?: favouritesUpsertWithoutVenueInput
    connect?: favouritesWhereUniqueInput
    disconnect?: boolean
    delete?: boolean
    update?: XOR<favouritesUpdateWithoutVenueInput, favouritesUncheckedUpdateWithoutVenueInput>
  }

  export type itinerary_placesUpdateOneWithoutVenueInput = {
    create?: XOR<itinerary_placesCreateWithoutVenueInput, itinerary_placesUncheckedCreateWithoutVenueInput>
    connectOrCreate?: itinerary_placesCreateOrConnectWithoutVenueInput
    upsert?: itinerary_placesUpsertWithoutVenueInput
    connect?: itinerary_placesWhereUniqueInput
    disconnect?: boolean
    delete?: boolean
    update?: XOR<itinerary_placesUpdateWithoutVenueInput, itinerary_placesUncheckedUpdateWithoutVenueInput>
  }
  ...
  export type favouritesUncheckedUpdateOneWithoutVenueInput = {
    create?: XOR<favouritesCreateWithoutVenueInput, favouritesUncheckedCreateWithoutVenueInput>
    connectOrCreate?: favouritesCreateOrConnectWithoutVenueInput
    upsert?: favouritesUpsertWithoutVenueInput
    connect?: favouritesWhereUniqueInput
  ...
  export type itinerary_placesUncheckedUpdateOneWithoutVenueInput = {
    create?: XOR<itinerary_placesCreateWithoutVenueInput, itinerary_placesUncheckedCreateWithoutVenueInput>
    connectOrCreate?: itinerary_placesCreateOrConnectWithoutVenueInput
    upsert?: itinerary_placesUpsertWithoutVenueInput
    connect?: itinerary_placesWhereUniqueInput
  ...
  export type venuesCreateNestedOneWithoutItinerary_placesInput = {
    create?: XOR<venuesCreateWithoutItinerary_placesInput, venuesUncheckedCreateWithoutItinerary_placesInput>
    connectOrCreate?: venuesCreateOrConnectWithoutItinerary_placesInput
    connect?: venuesWhereUniqueInput
  }
  ...
  export type venuesUpdateOneWithoutItinerary_placesInput = {
    create?: XOR<venuesCreateWithoutItinerary_placesInput, venuesUncheckedCreateWithoutItinerary_placesInput>
    connectOrCreate?: venuesCreateOrConnectWithoutItinerary_placesInput
    upsert?: venuesUpsertWithoutItinerary_placesInput
    connect?: venuesWhereUniqueInput
    disconnect?: boolean
    delete?: boolean
    update?: XOR<venuesUpdateWithoutItinerary_placesInput, venuesUncheckedUpdateWithoutItinerary_placesInput>
  }
  ...
  export type venuesCreateNestedOneWithoutFavouriteInput = {
    create?: XOR<venuesCreateWithoutFavouriteInput, venuesUncheckedCreateWithoutFavouriteInput>
    connectOrCreate?: venuesCreateOrConnectWithoutFavouriteInput
    connect?: venuesWhereUniqueInput
  }

  export type venuesUpdateOneWithoutFavouriteInput = {
    create?: XOR<venuesCreateWithoutFavouriteInput, venuesUncheckedCreateWithoutFavouriteInput>
    connectOrCreate?: venuesCreateOrConnectWithoutFavouriteInput
    upsert?: venuesUpsertWithoutFavouriteInput
    connect?: venuesWhereUniqueInput
    disconnect?: boolean
    delete?: boolean
    update?: XOR<venuesUpdateWithoutFavouriteInput, venuesUncheckedUpdateWithoutFavouriteInput>
  }
  ...
  export type favouritesCreateWithoutVenueInput = {
    user_id?: string | null
    bestFor?: InputJsonValue | null
    created_by?: number | null
    updated_by?: number | null
  ...
  export type favouritesUncheckedCreateWithoutVenueInput = {
    id?: number
    user_id?: string | null
    bestFor?: InputJsonValue | null
    created_by?: number | null
  ...
  export type favouritesCreateOrConnectWithoutVenueInput = {
    where: favouritesWhereUniqueInput
    create: XOR<favouritesCreateWithoutVenueInput, favouritesUncheckedCreateWithoutVenueInput>
  }

  export type itinerary_placesCreateWithoutVenueInput = {
    user_id?: string | null
    venue_data: InputJsonValue
    bestFor?: InputJsonValue | null
    created_by?: number | null
  ...
  export type itinerary_placesUncheckedCreateWithoutVenueInput = {
    id?: number
    itinerary_id: number
    user_id?: string | null
    venue_data: InputJsonValue
  ...
  export type itinerary_placesCreateOrConnectWithoutVenueInput = {
    where: itinerary_placesWhereUniqueInput
    create: XOR<itinerary_placesCreateWithoutVenueInput, itinerary_placesUncheckedCreateWithoutVenueInput>
  }
  ...
  export type favouritesUpsertWithoutVenueInput = {
    update: XOR<favouritesUpdateWithoutVenueInput, favouritesUncheckedUpdateWithoutVenueInput>
    create: XOR<favouritesCreateWithoutVenueInput, favouritesUncheckedCreateWithoutVenueInput>
  }

  export type favouritesUpdateWithoutVenueInput = {
    user_id?: NullableStringFieldUpdateOperationsInput | string | null
    bestFor?: InputJsonValue | null
    created_by?: NullableIntFieldUpdateOperationsInput | number | null
    updated_by?: NullableIntFieldUpdateOperationsInput | number | null
  ...
  export type favouritesUncheckedUpdateWithoutVenueInput = {
    id?: IntFieldUpdateOperationsInput | number
    user_id?: NullableStringFieldUpdateOperationsInput | string | null
    bestFor?: InputJsonValue | null
    created_by?: NullableIntFieldUpdateOperationsInput | number | null
  ...
  export type itinerary_placesUpsertWithoutVenueInput = {
    update: XOR<itinerary_placesUpdateWithoutVenueInput, itinerary_placesUncheckedUpdateWithoutVenueInput>
    create: XOR<itinerary_placesCreateWithoutVenueInput, itinerary_placesUncheckedCreateWithoutVenueInput>
  }

  export type itinerary_placesUpdateWithoutVenueInput = {
    user_id?: NullableStringFieldUpdateOperationsInput | string | null
    venue_data?: InputJsonValue
    bestFor?: InputJsonValue | null
    created_by?: NullableIntFieldUpdateOperationsInput | number | null
  ...
  export type itinerary_placesUncheckedUpdateWithoutVenueInput = {
    id?: IntFieldUpdateOperationsInput | number
    itinerary_id?: IntFieldUpdateOperationsInput | number
    user_id?: NullableStringFieldUpdateOperationsInput | string | null
    venue_data?: InputJsonValue
  ...
  export type venuesCreateWithoutItinerary_placesInput = {
    title?: string | null
    description?: string | null
    address?: string | null
    suburb?: string | null
  ...
  export type venuesUncheckedCreateWithoutItinerary_placesInput = {
    id?: number
    title?: string | null
    description?: string | null
    address?: string | null
  ...
  export type venuesCreateOrConnectWithoutItinerary_placesInput = {
    where: venuesWhereUniqueInput
    create: XOR<venuesCreateWithoutItinerary_placesInput, venuesUncheckedCreateWithoutItinerary_placesInput>
  }
  ...
  export type venuesUpsertWithoutItinerary_placesInput = {
    update: XOR<venuesUpdateWithoutItinerary_placesInput, venuesUncheckedUpdateWithoutItinerary_placesInput>
    create: XOR<venuesCreateWithoutItinerary_placesInput, venuesUncheckedCreateWithoutItinerary_placesInput>
  }

  export type venuesUpdateWithoutItinerary_placesInput = {
    title?: NullableStringFieldUpdateOperationsInput | string | null
    description?: NullableStringFieldUpdateOperationsInput | string | null
    address?: NullableStringFieldUpdateOperationsInput | string | null
    suburb?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type venuesUncheckedUpdateWithoutItinerary_placesInput = {
    id?: IntFieldUpdateOperationsInput | number
    title?: NullableStringFieldUpdateOperationsInput | string | null
    description?: NullableStringFieldUpdateOperationsInput | string | null
    address?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type venuesCreateWithoutFavouriteInput = {
    title?: string | null
    description?: string | null
    address?: string | null
    suburb?: string | null
  ...
  export type venuesUncheckedCreateWithoutFavouriteInput = {
    id?: number
    title?: string | null
    description?: string | null
    address?: string | null
  ...
  export type venuesCreateOrConnectWithoutFavouriteInput = {
    where: venuesWhereUniqueInput
    create: XOR<venuesCreateWithoutFavouriteInput, venuesUncheckedCreateWithoutFavouriteInput>
  }

  export type venuesUpsertWithoutFavouriteInput = {
    update: XOR<venuesUpdateWithoutFavouriteInput, venuesUncheckedUpdateWithoutFavouriteInput>
    create: XOR<venuesCreateWithoutFavouriteInput, venuesUncheckedCreateWithoutFavouriteInput>
  }

  export type venuesUpdateWithoutFavouriteInput = {
    title?: NullableStringFieldUpdateOperationsInput | string | null
    description?: NullableStringFieldUpdateOperationsInput | string | null
    address?: NullableStringFieldUpdateOperationsInput | string | null
    suburb?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type venuesUncheckedUpdateWithoutFavouriteInput = {
    id?: IntFieldUpdateOperationsInput | number
    title?: NullableStringFieldUpdateOperationsInput | string | null
    description?: NullableStringFieldUpdateOperationsInput | string | null
    address?: NullableStringFieldUpdateOperationsInput | string | null
