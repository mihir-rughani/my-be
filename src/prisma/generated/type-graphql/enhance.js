...
const crudResolversMap = {
    ...
    Favourites: crudResolvers.FavouritesCrudResolver
};
const relationResolversMap = {
    ...
    Favourites: relationResolvers.FavouritesRelationsResolver
};
const actionResolversMap = {
    ...
    Favourites: {
        findUniqueFavourites: actionResolvers.FindUniqueFavouritesResolver,
        findFirstFavourites: actionResolvers.FindFirstFavouritesResolver,
        findManyFavourites: actionResolvers.FindManyFavouritesResolver,
        createFavourites: actionResolvers.CreateFavouritesResolver,
        createManyFavourites: actionResolvers.CreateManyFavouritesResolver,
        deleteFavourites: actionResolvers.DeleteFavouritesResolver,
        updateFavourites: actionResolvers.UpdateFavouritesResolver,
        deleteManyFavourites: actionResolvers.DeleteManyFavouritesResolver,
        updateManyFavourites: actionResolvers.UpdateManyFavouritesResolver,
        upsertFavourites: actionResolvers.UpsertFavouritesResolver,
        aggregateFavourites: actionResolvers.AggregateFavouritesResolver,
        groupByFavourites: actionResolvers.GroupByFavouritesResolver
    }
};
const resolversInfo = {
    ...
    Favourites: ["findUniqueFavourites", "findFirstFavourites", "findManyFavourites", "createFavourites", "createManyFavourites", "deleteFavourites", "updateFavourites", "deleteManyFavourites", "updateManyFavourites", "upsertFavourites", "aggregateFavourites", "groupByFavourites"]
};
const relationResolversInfo = {
    Upload_file: ["uploadFileMorph"],
    Upload_file_morph: ["uploadFile", "venues"],
    VenueType: ["venues"],
    Venues: ["venueType", "uploadFileMorph", "favourite", "itinerary_places"],
    Itinerary: ["places"],
    Itinerary_places: ["venue", "itinerary"],
    Favourites: ["venue"]
};
const modelsInfo = {
    ...
    Itinerary_places: ["id", "itinerary_id", "user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue_id"],
    Favourites: ["id", "user_id", "bestFor", "venue_id", "created_by", "updated_by", "created_at", "updated_at"]
};
const inputsInfo = {
    ...
    Itinerary_placesWhereInput: ["AND", "OR", "NOT", "id", "itinerary_id", "user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue_id", "venue", "itinerary"],
    Itinerary_placesOrderByInput: ["id", "itinerary_id", "user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue_id"],
    Itinerary_placesWhereUniqueInput: ["id"],
    Itinerary_placesScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "itinerary_id", "user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue_id"],
    FavouritesWhereInput: ["AND", "OR", "NOT", "id", "user_id", "bestFor", "venue_id", "created_by", "updated_by", "created_at", "updated_at", "venue"],
    FavouritesOrderByInput: ["id", "user_id", "bestFor", "venue_id", "created_by", "updated_by", "created_at", "updated_at"],
    FavouritesWhereUniqueInput: ["id"],
    FavouritesScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "user_id", "bestFor", "venue_id", "created_by", "updated_by", "created_at", "updated_at"],
    ...
    VenuesCreateInput: ["title", "description", "address", "suburb", "city", "postCode", "lat", "lon", "website", "breakfast", "lunch", "dinner", "visible", "created_by", "updated_by", "created_at", "updated_at", "test", "cosy", "romantic", "weddings", "post_code", "bachelor_party", "hen_party", "outdoor_area", "outdoor_dinning", "outdoor_bar", "venueType", "uploadFileMorph", "favourite", "itinerary_places"],
    VenuesUpdateInput: ["title", "description", "address", "suburb", "city", "postCode", "lat", "lon", "website", "breakfast", "lunch", "dinner", "visible", "created_by", "updated_by", "created_at", "updated_at", "test", "cosy", "romantic", "weddings", "post_code", "bachelor_party", "hen_party", "outdoor_area", "outdoor_dinning", "outdoor_bar", "venueType", "uploadFileMorph", "favourite", "itinerary_places"],
    ...
    Itinerary_placesCreateInput: ["user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue", "itinerary"],
    Itinerary_placesUpdateInput: ["user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue", "itinerary"],
    Itinerary_placesCreateManyInput: ["id", "itinerary_id", "user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue_id"],
    Itinerary_placesUpdateManyMutationInput: ["user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time"],
    FavouritesCreateInput: ["user_id", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "venue"],
    FavouritesUpdateInput: ["user_id", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "venue"],
    FavouritesCreateManyInput: ["id", "user_id", "bestFor", "venue_id", "created_by", "updated_by", "created_at", "updated_at"],
    FavouritesUpdateManyMutationInput: ["user_id", "bestFor", "created_by", "updated_by", "created_at", "updated_at"],
    ...
    FavouritesRelationFilter: ["is", "isNot"],
    Itinerary_placesRelationFilter: ["is", "isNot"],
    ...
    FavouritesCreateNestedOneWithoutVenueInput: ["create", "connectOrCreate", "connect"],
    Itinerary_placesCreateNestedOneWithoutVenueInput: ["create", "connectOrCreate", "connect"],
    ...
    FavouritesUpdateOneWithoutVenueInput: ["create", "connectOrCreate", "upsert", "connect", "disconnect", "delete", "update"],
    Itinerary_placesUpdateOneWithoutVenueInput: ["create", "connectOrCreate", "upsert", "connect", "disconnect", "delete", "update"],
    ...
    VenuesCreateNestedOneWithoutItinerary_placesInput: ["create", "connectOrCreate", "connect"],
    ItineraryCreateNestedOneWithoutPlacesInput: ["create", "connectOrCreate", "connect"],
    VenuesUpdateOneWithoutItinerary_placesInput: ["create", "connectOrCreate", "upsert", "connect", "disconnect", "delete", "update"],
    ItineraryUpdateOneWithoutPlacesInput: ["create", "connectOrCreate", "upsert", "connect", "disconnect", "delete", "update"],
    VenuesCreateNestedOneWithoutFavouriteInput: ["create", "connectOrCreate", "connect"],
    VenuesUpdateOneWithoutFavouriteInput: ["create", "connectOrCreate", "upsert", "connect", "disconnect", "delete", "update"],
    ...
    VenuesCreateWithoutUploadFileMorphInput: ["title", "description", "address", "suburb", "city", "postCode", "lat", "lon", "website", "breakfast", "lunch", "dinner", "visible", "created_by", "updated_by", "created_at", "updated_at", "test", "cosy", "romantic", "weddings", "post_code", "bachelor_party", "hen_party", "outdoor_area", "outdoor_dinning", "outdoor_bar", "venueType", "favourite", "itinerary_places"],
    ...
    VenuesUpdateWithoutUploadFileMorphInput: ["title", "description", "address", "suburb", "city", "postCode", "lat", "lon", "website", "breakfast", "lunch", "dinner", "visible", "created_by", "updated_by", "created_at", "updated_at", "test", "cosy", "romantic", "weddings", "post_code", "bachelor_party", "hen_party", "outdoor_area", "outdoor_dinning", "outdoor_bar", "venueType", "favourite", "itinerary_places"],
    VenuesCreateWithoutVenueTypeInput: ["title", "description", "address", "suburb", "city", "postCode", "lat", "lon", "website", "breakfast", "lunch", "dinner", "visible", "created_by", "updated_by", "created_at", "updated_at", "test", "cosy", "romantic", "weddings", "post_code", "bachelor_party", "hen_party", "outdoor_area", "outdoor_dinning", "outdoor_bar", "uploadFileMorph", "favourite", "itinerary_places"],
    ...
    FavouritesCreateWithoutVenueInput: ["user_id", "bestFor", "created_by", "updated_by", "created_at", "updated_at"],
    FavouritesCreateOrConnectWithoutVenueInput: ["where", "create"],
    Itinerary_placesCreateWithoutVenueInput: ["user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "itinerary"],
    Itinerary_placesCreateOrConnectWithoutVenueInput: ["where", "create"],
    ...
    FavouritesUpsertWithoutVenueInput: ["update", "create"],
    FavouritesUpdateWithoutVenueInput: ["user_id", "bestFor", "created_by", "updated_by", "created_at", "updated_at"],
    Itinerary_placesUpsertWithoutVenueInput: ["update", "create"],
    Itinerary_placesUpdateWithoutVenueInput: ["user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "itinerary"],
    Itinerary_placesCreateWithoutItineraryInput: ["user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue"],
    ...
    Itinerary_placesScalarWhereInput: ["AND", "OR", "NOT", "id", "itinerary_id", "user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue_id"],
    VenuesCreateWithoutItinerary_placesInput: ["title", "description", "address", "suburb", "city", "postCode", "lat", "lon", "website", "breakfast", "lunch", "dinner", "visible", "created_by", "updated_by", "created_at", "updated_at", "test", "cosy", "romantic", "weddings", "post_code", "bachelor_party", "hen_party", "outdoor_area", "outdoor_dinning", "outdoor_bar", "venueType", "uploadFileMorph", "favourite"],
    VenuesCreateOrConnectWithoutItinerary_placesInput: ["where", "create"],
    ...
    VenuesUpsertWithoutItinerary_placesInput: ["update", "create"],
    VenuesUpdateWithoutItinerary_placesInput: ["title", "description", "address", "suburb", "city", "postCode", "lat", "lon", "website", "breakfast", "lunch", "dinner", "visible", "created_by", "updated_by", "created_at", "updated_at", "test", "cosy", "romantic", "weddings", "post_code", "bachelor_party", "hen_party", "outdoor_area", "outdoor_dinning", "outdoor_bar", "venueType", "uploadFileMorph", "favourite"],
    ...
    VenuesCreateWithoutFavouriteInput: ["title", "description", "address", "suburb", "city", "postCode", "lat", "lon", "website", "breakfast", "lunch", "dinner", "visible", "created_by", "updated_by", "created_at", "updated_at", "test", "cosy", "romantic", "weddings", "post_code", "bachelor_party", "hen_party", "outdoor_area", "outdoor_dinning", "outdoor_bar", "venueType", "uploadFileMorph", "itinerary_places"],
    VenuesCreateOrConnectWithoutFavouriteInput: ["where", "create"],
    VenuesUpsertWithoutFavouriteInput: ["update", "create"],
    ...
    VenuesUpdateWithoutVenueTypeInput: ["title", "description", "address", "suburb", "city", "postCode", "lat", "lon", "website", "breakfast", "lunch", "dinner", "visible", "created_by", "updated_by", "created_at", "updated_at", "test", "cosy", "romantic", "weddings", "post_code", "bachelor_party", "hen_party", "outdoor_area", "outdoor_dinning", "outdoor_bar", "uploadFileMorph", "favourite", "itinerary_places"],
    ...
    Itinerary_placesCreateManyItineraryInput: ["id", "user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue_id"],
    Itinerary_placesUpdateWithoutItineraryInput: ["user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue"]
};
const outputsInfo = {
    ...
    Itinerary_placesGroupBy: ["id", "itinerary_id", "user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue_id", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateFavourites: ["_count", "_avg", "_sum", "_min", "_max"],
    FavouritesGroupBy: ["id", "user_id", "bestFor", "venue_id", "created_by", "updated_by", "created_at", "updated_at", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    Itinerary_placesCountAggregate: ["id", "itinerary_id", "user_id", "venue_data", "bestFor", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue_id", "_all"],
    Itinerary_placesAvgAggregate: ["id", "itinerary_id", "created_by", "updated_by", "venue_id"],
    Itinerary_placesSumAggregate: ["id", "itinerary_id", "created_by", "updated_by", "venue_id"],
    Itinerary_placesMinAggregate: ["id", "itinerary_id", "user_id", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue_id"],
    Itinerary_placesMaxAggregate: ["id", "itinerary_id", "user_id", "created_by", "updated_by", "created_at", "updated_at", "date", "time", "venue_id"],
    FavouritesCountAggregate: ["id", "user_id", "bestFor", "venue_id", "created_by", "updated_by", "created_at", "updated_at", "_all"],
    FavouritesAvgAggregate: ["id", "venue_id", "created_by", "updated_by"],
    FavouritesSumAggregate: ["id", "venue_id", "created_by", "updated_by"],
    FavouritesMinAggregate: ["id", "user_id", "venue_id", "created_by", "updated_by", "created_at", "updated_at"],
    FavouritesMaxAggregate: ["id", "user_id", "venue_id", "created_by", "updated_by", "created_at", "updated_at"]
};
const argsInfo = {
    ...
    FindUniqueFavouritesArgs: ["where"],
    FindFirstFavouritesArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindManyFavouritesArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    CreateFavouritesArgs: ["data"],
    CreateManyFavouritesArgs: ["data", "skipDuplicates"],
    DeleteFavouritesArgs: ["where"],
    UpdateFavouritesArgs: ["data", "where"],
    DeleteManyFavouritesArgs: ["where"],
    UpdateManyFavouritesArgs: ["data", "where"],
    UpsertFavouritesArgs: ["where", "create", "update"],
    AggregateFavouritesArgs: ["where", "orderBy", "cursor", "take", "skip"],
    GroupByFavouritesArgs: ["where", "orderBy", "by", "having", "take", "skip"]
};
