...
const modelsInfo = {
    ...
    Venues: ["id", "title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type"],
...
const inputsInfo = {
    ...
    VenueTypeWhereInput: ["AND", "OR", "NOT", "id", "created_by", "updated_by", "created_at", "updated_at", "name"],
    ...
    VenuesWhereInput: ["AND", "OR", "NOT", "id", "title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type", "uploadFileMorph"],
    VenuesOrderByInput: ["id", "title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type"],
    VenuesWhereUniqueInput: ["id"],
    VenuesScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type"],
    ...
    VenueTypeCreateInput: ["created_by", "updated_by", "created_at", "updated_at", "name"],
    VenueTypeUpdateInput: ["created_by", "updated_by", "created_at", "updated_at", "name"],
    ...
    VenuesCreateInput: ["title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type", "uploadFileMorph"],
    VenuesUpdateInput: ["title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type", "uploadFileMorph"],
    VenuesCreateManyInput: ["id", "title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type"],
    VenuesUpdateManyMutationInput: ["title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type"],
    ...
    VenuesCreateWithoutUploadFileMorphInput: ["title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type"],
    ...
    VenuesUpdateWithoutUploadFileMorphInput: ["title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type"],
...
const outputsInfo = {
    ...
    VenuesGroupBy: ["id", "title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    VenuesCountAggregate: ["id", "title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type", "_all"],
    VenuesAvgAggregate: ["id", "lat", "lon", "created_by", "updated_by", "venue_type"],
    VenuesSumAggregate: ["id", "lat", "lon", "created_by", "updated_by", "venue_type"],
    VenuesMinAggregate: ["id", "title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type"],
    VenuesMaxAggregate: ["id", "title", "description", "suburb", "city", "postCode", "lat", "lon", "breakfast", "lunch", "dinner", "bachelorParty", "henParty", "visible", "published_at", "created_by", "updated_by", "created_at", "updated_at", "venue_type"],
